...
3. Install & update fuzzapi gem dependencies [rails 6.0.2.2](https://rubygems.org/gems/rails/versions) + [ruby 2.7.1](https://www.ruby-lang.org/en/downloads/releases/)

       bundle update && gem install API_Fuzzer && gem install rails -v 6.0.2.2 && rvm install 2.7.1 & rvm use 2.7.1 && gem install rubygems-update && update_rubygems && gem update --system && sudo gem update && gem update `gem outdated | cut -d ' ' -f 1` && bundle install
